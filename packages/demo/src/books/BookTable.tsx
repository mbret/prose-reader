import { Box, Table, Thead, Tr, Th, Tbody, Td, Link, Text } from "@chakra-ui/react"
import React from "react"
import { Link as RouterLink } from "react-router-dom"

export const BookTable = ({ items, title }: { title: string; items: { name: string; link: string; type: string }[] }) => (
