...
type Props = ComponentProps<typeof Box> & { leftElement?: React.ReactElement, middleElement?: React.ReactElement | string, rightElement?: React.ReactElement }
            ...
            <Box paddingX={2} overflow="auto" flexGrow={1} display="flex" justifyContent="center">
                {
                    typeof middleElement === `string`
                        ? (
                            <Text as="h1" isTruncated>{middleElement}</Text>
                        )
                        : middleElement
                }
            </Box>
