...
const createGestureHandler = (reader) => {
    ...
    hammerManager === null || hammerManager === void 0 ? void 0 : hammerManager.on('tap', ({ srcEvent }) => {
        ...
        const normalizedEvent = (reader === null || reader === void 0 ? void 0 : reader.normalizeEvent(srcEvent)) || {};
    ...
    hammerManager.on('panmove panstart panend', (ev) => {
        const normalizedEvent = reader === null || reader === void 0 ? void 0 : reader.normalizeEvent(ev.srcEvent);
