      ...
      >
        <Box flexDirection="column" gap={2} display="flex">
          ...
          <Box flexDirection="column" gap={2} display="flex" mt={2}>
            <Text>
              Prose handle the complex functionality like rendering and
              pagination, while giving you complete creative freedom over the
              design. You can even use our demo as starting point.
            </Text>
            <Text>
              Integrate it with React, Svelte, React Native or anything really.
              It&apos;s that easy.
            </Text>
            <Button asChild alignSelf="flex-start" mt={2}>
              <Link to={DEMO_BASE_PATH}>Visit the demo</Link>
            </Button>
          </Box>
        </Box>
        <Image
